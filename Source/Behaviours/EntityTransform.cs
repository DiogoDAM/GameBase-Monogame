...
public class EntityTransform
{
	...
	public EntityTransform(EntityTransform parent) { Parent = parent; }

	public EntityTransform(Vector2 pos) { Position = pos; }

	public EntityTransform(Vector2 pos, float rotation, Vector2 scale) { Position = pos; Rotation = rotation; Scale = scale; }
